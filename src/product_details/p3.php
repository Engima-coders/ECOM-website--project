...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://images-static.nykaa.com/media/catalog/product/4/5/459410fn73395_1.jpg?tr=w-500" class="card-img-top" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">TRENDING JEWELLERY SET</h2>
        <h3 class="text-success">₹239</h3>
       ...
       <p><strong>Name :</strong> TRENDING JEWELLERY SET</p>
    <p><strong>Base Metal :</strong> Brass & Copper</p>
    <p><strong>Plating :</strong> Gold Plated</p>
    <p><strong>Stone Type :</strong> Artificial Stones</p>
    <p><strong>Type :</strong> Pendant with Chain</p>
    <p><strong>Net Quantity (N) :</strong> 1</p>
    <p><strong>Sizes :</strong> Free Size</p>

    <p>
      We are available to you for the best and most reasonable price in the market as compared to others.
      We reduce overall cost by cutting all the middlemen and directly reaching to retail buyer. These savings are passed on to our customers by providing them with less expensive but genuine and pure product.
    </p>

    <p>
      This antique necklace set is made by gold plated-alloy, kemp stone, which will make the women more charming on the wedding, party or other occasion.
      Traditional ethnic bead necklace set with earring for women. Earring is very easy to use being lightweight and has a design which makes it very comfortable for use by women.
    </p>

    <p>
      WE ARE THE MANUFACTURER OF IMITATION JEWELRY FOR EVERY SEASON AND REASON.
      WE ARE USING BEST RAW MATERIAL AND DESIGNERS FOR MORE CUSTOMER SATISFACTION.
      WE PROVIDE ALLOY ORIENTED PRODUCTS WITH MATTED PLATTING AND ANTIQUE PLATTING.
    </p>

    <p>
      THESE PRODUCTS ARE VERY ATTRACTIVE FOR WOMEN AND GIRLS.
      UPCOMING DAYS IT WILL BE MORE SUITABLE FOR MEN AND BOYS TO GIFT THEIR LOVED ONES.
    </p>
