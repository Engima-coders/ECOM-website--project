...
<body>
  ...
  <p>Simply register with your mobile number to join. Provide your number at checkout in-store or log in to your registered account while shopping online at <a href="#">yourwebsite.com</a> to earn and redeem rewards.</p>

  <h3>Stylish Club Subscription – How to Join?</h3>
  <p>To join Stylish Club in-store, just give your mobile number during checkout or give a missed call to <strong>0800 778 2345</strong>. To register online, sign up with your mobile number and email at <a href="#">yourwebsite.com</a>, fill out your profile, and verify via OTP.</p>
  ...
  <p>Bonus points come with a limited-time validity (shared via SMS). They expire at 11:59 PM on the given date. No revalidation requests accepted. Use them on <a href="#">yourwebsite.com</a> or in-store before they expire.</p>
  ...
  <p>All benefits activate from your second purchase. Plus, returns are <strong>free for Stylish Club Members</strong>. <a href="#">yourwebsite.com/delivery-returns</a></p>
</div>
  </section>
</body>
</html>
