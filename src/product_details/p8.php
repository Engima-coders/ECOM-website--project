...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://imagescdn.louisphilippe.com/img/app/product/3/39683398-15124912.jpg?auto=format&w=390" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">GLAUCUS Premium Elegant Men Formal Suit</h2>
  ...
  <h3>Product Details</h3>
     ...
     <p><strong>Name :</strong> GLAUCUS Premium Elegant Men Formal Trouser Pant</p>
    <p><strong>Fabric :</strong> Polycotton</p>
    <p><strong>Pattern :</strong> Solid</p>
    <p><strong>Net Quantity (N) :</strong> 1</p>

    <p>
      GLAUCUS Premium Elegant Men Formal Trouser Pant. Features: Full Length, Slant pocket with back welt pocket, Comfortable, Nice Fitting, 4 Pockets. Button closure with zip fly. If you are in between sizes, go for a size higher. Packet contains 1 trouser. The side pockets allow you to comfortably place your palms inside them along with storing wallets and handkerchiefs. The mid-waist rise provides a modern look and the belt loops allow a customized fit when a belt is slipped through the loops. You can pair these men formal trousers with your favorite formal shirt to match your professionalism. This pant makes getting ready for work hassle-free. Made from a comfortable cotton blend, these multicolor trousers have flat front styling and fitted waistbands for a clean, polished look. Wrinkle-resistant and machine washable for low maintenance, these well-made pants will hold up season after season and keep you looking sharp.
    </p>
