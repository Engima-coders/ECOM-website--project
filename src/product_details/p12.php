...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://images.meesho.com/images/products/555302694/wmr3e_512.avif?width=512" class="card-img-top" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">Rabbit School Stationery Kit (18 Products) – 10 Pencils, 2 Erasers, 2 Sharpeners, 1 Scale, 10 Wax Cryons, 12 Sketch Pens, 1 Pouch Perfect Stationery Set for Kids| School Kit For Kids With Pouch</h2>
        <h3 class="text-success">₹399</h3>
       ...
       <button class="size-btn">
        ...
        <p><strong>Name :</strong> Rabbit School Stationery Kit (18 Products) – 10 Pencils, 2 Erasers, 2 Sharpeners, 1 Scale, 10 Wax Cryons, 12 Sketch Pens, 1 Pouch Perfect Stationery Set for Kids | School Kit For Kids With Pouch</p>
    <p><strong>Material :</strong> Plastic</p>
    <p><strong>Type :</strong> Multipurpose Pouches</p>
    <p><strong>Recommended Age :</strong> 5 - 7 years</p>
    <p><strong>Net Quantity (N) :</strong> 1</p>

    <p><strong>Description :</strong></p>
    <p>
      Unleash your child's creativity with the Rabbit Champ Complete Stationery Kit for Kids, a perfect all-in-one school and art supply set. This colorful stationery kit includes sketch pens, pencils, a sharpener, eraser, wax crayons, and scale – everything your child needs for school projects, homework, drawing, and activities.
    </p>
    <p>
      Designed for both boys and girls, this school stationery set is safe, child-friendly, and ideal for back-to-school, birthday return gifts, or as an educational gift for kids. Keep your little one organized, creative, and learning with this complete stationery kit for kids.
    </p>

    <p><strong>Tags :</strong></p>
    <ul>
      <li>Trendy Stationery Kit Pencils</li>
      <li>Classic Stationery Sets</li>
      <li>Trendy Classic Kits</li>
      <li>Stationery Kits for kids</li>
    </ul>
