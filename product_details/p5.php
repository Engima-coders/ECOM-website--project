...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://assets.myntassets.com/w_412,q_60,dpr_2,fl_progressive/assets/images/5394086/2024/3/27/fac7a437-ba0a-425b-8591-1e55480312611711539929437-Hancock-Men-Black-Slim-Fit-Solid-Formal-Shirt-53171153992888-1.jpg" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">Stylish Glamorous Men Shirts</h2>
  ...
  <h3>Product Details</h3>
   ...
   <p><strong>Name :</strong> Stylish Glamorous Men Shirts</p>
    <p><strong>Fabric :</strong> Polycotton</p>
    <p><strong>Sleeve Length :</strong> Long Sleeves</p>
    <p><strong>Pattern :</strong> Checked</p>
    <p><strong>Net Quantity (N) :</strong> 1</p>
    <p><strong>Sizes :</strong></p>
    <ul>
      <li>S (Chest Size : 40 in, Length Size: 29 in)</li>
      <li>M (Chest Size : 42 in, Length Size: 30 in)</li>
      <li>L (Chest Size : 40 in, Length Size: 29 in)</li>
      <li>XL (Chest Size : 42 in, Length Size: 29 in)</li>
      <li>XXL (Chest Size : 48 in, Length Size: 32 in)</li>
    </ul>
