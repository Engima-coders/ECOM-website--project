...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMhn8LbSHzkcnBhfKg8HKIs8ysR5PWdFApKQ&s" class="card-img-top" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">Trendy men watches</h2>
       ...
       <p><strong>Name :</strong> Trendy men watches</p>
    <p><strong>Strap Material :</strong> Metal</p>
    <p><strong>Case :</strong> Rectangular</p>
    <p><strong>Case/Bezel Material :</strong> Alloy</p>
    <p><strong>Clasp Type :</strong> Buckle</p>
    <p><strong>Date Display :</strong> Yes</p>
    <p><strong>Dial Design :</strong> Solid</p>
    <p><strong>Dial Shape :</strong> Square</p>
    <p><strong>Display Type :</strong> Analog</p>
    <p><strong>Dual Time :</strong> No</p>
    <p><strong>Gps :</strong> No</p>
    <p><strong>Light :</strong> No</p>
    ...
    <p><strong>Water Resistance :</strong> No</p>
    <p><strong>Add On :</strong> Others</p>
