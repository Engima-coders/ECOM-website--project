...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://m.media-amazon.com/images/I/51QbZMq2IcL._SY695_.jpg" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">Womens boots</h2>
        <h3 class="text-success">₹599</h3>
  ...
  <h3>Product Details</h3>
   ...
   <p><strong>Name :</strong> Womens boots</p>
    ...
    <p>IND-4 (Foot Length Size : 24.3 cm)</p>
    <p>IND-5 (Foot Length Size : 25 cm)</p>
    <p>IND-6 (Foot Length Size : 25.5 cm)</p>
    <p>IND-7 (Foot Length Size : 26.1 cm)</p>
    <p>IND-8 (Foot Length Size : 26.7 cm)</p>
