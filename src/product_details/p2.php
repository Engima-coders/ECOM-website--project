...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://befashionate.in/cdn/shop/products/tfh-sandalwood-09-sw-406-A_97512530-a847-4bc9-bf21-ea6fae4a8f36.jpg?v=1688054668" class="card-img-top" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">Evocative Embellished Soft Banarasi Silk Saree With Admirable Blouse Piece</h2>
        <h3 class="text-success">₹449</h3>
    ...
    <p><strong>Name :</strong> Evocative Embellished Soft Banarasi Silk Saree With Admirable Blouse Piece</p>
    <p><strong>Saree Fabric :</strong> Jacquard</p>
    <p><strong>Blouse :</strong> Running Blouse</p>
    <p><strong>Blouse Fabric :</strong> Jacquard</p>
    <p><strong>Pattern :</strong> Woven Design</p>
    <p><strong>Blouse Pattern :</strong> Woven Design</p>
    <p><strong>Net Quantity (N) :</strong> Single</p>

    <p><strong>Name :</strong> Self Design, Woven Kanjivaram Jacquard, Art Silk Saree (White)</p>
    <p><strong>Saree Fabric :</strong> Art Silk</p>
    <p><strong>Blouse :</strong> Running Blouse</p>
    <p><strong>Blouse Fabric :</strong> Jacquard</p>
    <p><strong>Pattern :</strong> Zari Woven</p>
    <p><strong>Blouse Pattern :</strong> Solid</p>
    <p><strong>Net Quantity (N) :</strong> Single</p>

    <p>
      Saree(Sari) have Jacquard Woven Work In Art Silk Fabric With Unstitched Blouse Piece.
      Those sarees look pretty awesome for Casual, Daily, Party, Festive & Wedding Occasion.
      Pair this with beautiful jewellery and a pair of heels and you will look beautiful.
    </p>

    <p><strong>Sizes :</strong><br>
      Free Size (Saree Length Size: 5.5 m, Blouse Length Size: 0.9 m)
    </p>
