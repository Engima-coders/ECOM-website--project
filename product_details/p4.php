...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://www.algenhealthcare.co/wp-content/uploads/2024/09/Top-15-Cosmetic-Manufacturers-In-Gujarat.jpg" class="card-img-top" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">HD Face Makeup combo Kits 12 Items</h2>
       ...
       <button class="size-btn">
        ...
        <p><strong>Name :</strong> HD Face Makeup combo Kits 12 Items</p>
    <p><strong>Product Name :</strong> HD Face Makeup combo Kits 12 Items</p>
    <p><strong>Flavour :</strong> Fruits</p>
    <p><strong>Net Quantity (N) :</strong> 12</p>
    <p><strong>Skin Type :</strong> All Skin Types</p>
    <p><strong>Type :</strong> Liquid</p>
    <p><strong>Capacity :</strong> 100-200gm</p>
    <p><strong>Shade :</strong> Black</p>
