...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://m.media-amazon.com/images/I/718wgbt1Z0L._SX695_.jpg" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">FOOTEEN-MEN'S CASUAL CLOGS/MEN'S FLAT SANDAL/DAILY USE SLIPPERS/COMFORTABLE & LIGHTWEIGHT CLOGS</h2>
        <h3 class="text-success">₹265</h3>
  ...
  <h3>Product Details</h3>
    ...
    <p><strong>Name :</strong> FOOTEEN-MEN'S CASUAL CLOGS/MEN'S FLAT SANDAL/DAILY USE SLIPPERS/COMFORTABLE & LIGHTWEIGHT CLOGS</p>
    <p><strong>Material :</strong> EVA</p>
    <p><strong>Sole Material :</strong> Eva</p>
    <p><strong>Pattern :</strong> Solid</p>
    <p><strong>Net Quantity (N) :</strong> 1</p>

    <p>So SOFT & COMFORTABLE CLOGS / EASY TO WASH / EASY TO WEAR / BREATHABLE / OPTIONAL USE STRAP / GRIPPY SOLES</p>
