...
<body>
  <div class="container py-4">
    ...
    <div class="row">
      <!-- Image Gallery -->
      <div class="col-md-5">
        <img src="https://m.media-amazon.com/images/I/51hUvRQ9UlL._SY695_.jpg" class="img-fluid mb-3" alt="Main Product">
...
<!-- Seller Info -->
  ...
  <p><strong>Country of Origin :</strong> India</p>
      ...
      <!-- Product Info -->
      <div class="col-md-7">
        <h2 class="product-title">Kid's Unisex Sport Running,Walking,Party & School Shoes Lightweight Casual Shoes </h2>
  ...
  <h3>Product Details</h3>
   ...
   <p><strong>Name :</strong> Kid's Unisex Sport Running, Walking, Party & School Shoes Lightweight Casual Shoes for Boy's (Navy Blue)</p>
    <p><strong>Material :</strong> Synthetic</p>
    <p><strong>Sole Material :</strong> Pvc</p>
    <p><strong>Type :</strong> Running Shoes</p>
    <p><strong>Ideal For :</strong> Boys</p>
    <p><strong>Fastening & Back Detail :</strong> Lace-Up</p>
    <p><strong>Insole :</strong> Comfort</p>
    ...
    <p>4-5 Years, 6-8 Years, 9-10 Years, 10-11 Years, 11-12 Years</p>
</div>
